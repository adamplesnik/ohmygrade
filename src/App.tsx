...
function App() {
  return (
    <div className="bg-product-foreground text-product-on-foreground flex h-screen w-screen flex-col items-center justify-center gap-12 p-6 font-sans md:p-8 lg:p-10">
